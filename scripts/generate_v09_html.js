...
const CLIPS = [
  {
    ...
    icon: "warning",
    badgeClass: "red",
    text: "En el mundo financiero, un empleado bancario descubrió cómo robar millones de dólares sin encender una sola alarma de seguridad.",
    title: "ROBO SILENCIOSO",
    question: "¿Robo invisible?",
    reveal: "Fraude Bancario",
    isHook: true,
  },
  {
    id: "c2",
    start: 8.0,
    duration: 8.0,
    badge: "Fraude Digital",
    icon: "error",
    badgeClass: "red",
    text: "Utilizó la famosa 'Técnica del Salami', alterando el software para desviar fracciones de centavos de miles de transacciones hacia su cuenta.",
  },
  {
    id: "c3",
    start: 16.0,
    ...
    icon: "trending_up",
    badgeClass: "yellow",
    text: "Al ser cantidades microscópicas, los clientes no lo notaban. El robo automatizado acumuló una inmensa fortuna de forma silenciosa e indetectable.",
  },
  {
    id: "c4",
    start: 24.0,
    ...
    icon: "policy",
    badgeClass: "yellow",
    text: "Hasta que una auditoría forense intervino. Los peritos informáticos aislaron los servidores del banco aplicando el protocolo de 'Obtención por Aseguramiento'.",
  },
  {
    id: "c5",
    start: 32.0,
    ...
    icon: "analytics",
    badgeClass: "green",
    text: "Utilizando duplicadores forenses, crearon imágenes exactas de los discos duros, blindando la evidencia con inquebrantables algoritmos matemáticos Hash.",
  },
  {
    id: "c6",
    start: 40.0,
    ...
    icon: "code",
    badgeClass: "red",
    text: "El análisis profundo del código fuente y las bases de datos reveló el engaño: instrucciones ocultas que automatizaban el desvío sistemático.",
  },
  {
    id: "c7",
    start: 48.0,
    ...
    icon: "gavel",
    badgeClass: "green",
    text: "Esta alteración maliciosa o 'falsificación informática' fue la prueba reina. El empleado enfrentó severos cargos y prisión por Fraude Informático.",
  },
  {
    id: "c8",
    start: 56.0,
    ...
    icon: "share",
    badgeClass: "green",
    text: "La lección: en la informática forense, los robos microscópicos dejan huellas gigantes. Audita tus sistemas, ¡guarda este video y compártelo!",
    isCloser: true,
  },
];
...
<!-- sha256-v09 · SHA256.US Laboratorio Forense · 64s · 1080x1920 · 30fps -->
<html lang="es">
  <head>
    <meta charset="UTF-8" />
    <title>SHA256.US — La Técnica del Salami y Fraude Informático</title>
    <!-- Material Icons -->
    ...
    <style type="text/tailwindcss">
      ...
      *::after {
      ...
      .progress-bar-fill.yellow {
        ...
        box-shadow: 0 0 10px rgba(254, 207, 6, 0.5);
      }
      .progress-bar-label {
        font-family: "Share Tech Mono", monospace;
        font-size: 20px;
  ...
  <body>
    <div
      id="sha256-v09"
      data-composition-id="sha256-v09"
      data-width="1080"
      data-height="1920"
      data-start="0"
      data-duration="64.0"
    >
      ...
      <div id="c1" class="scene-wrap">
        ...
        <div class="hook-wrap">
          ...
          <div id="c1-title" class="hook-title">ROBO MICROSCÓPICO</div>
          <div id="c1-line" class="hook-line"></div>
        </div>
      </div>

      <!-- ── SCENE 2 — Fraude Digital (8.0–16.0s) ── -->
      <div id="c2" class="scene-wrap">
        ...
        <div class="scene-content">
          <div id="c2-dashed-box" class="dashed-box" style="border-color: var(--red);">
            ...
            <div id="c2-label" class="meta-label-mono red">DESVÍO SISTEMÁTICO DE CENTAVOS</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 3 — Desvío Micro (16.0–24.0s) ── -->
      <div id="c3" class="scene-wrap">
        ...
        <div class="scene-content">
          <div id="c3-badge" class="badge">
            <span class="material-icons" style="font-size:32px;color:#fecf06;">trending_up</span>
            Desvío Micro
          </div>
          <div id="c3-progress-container" class="progress-bar-container">
            <div class="progress-bar-title">ACUMULACIÓN DE SALDO FRAUDULENTO</div>
            <div class="progress-bar-track">
              <div id="c3-bar" class="progress-bar-fill yellow"></div>
            </div>
            <div class="progress-bar-label">TOTAL EXTRAÍDO SILENCIOSAMENTE</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 4 — Aseguramiento (24.0–32.0s) ── -->
      <div id="c4" class="scene-wrap">
        ...
        <div class="scene-content">
          <div id="c4-badge" class="badge red">
            <span class="material-icons" style="font-size:32px;color:#ff3b30;">policy</span>
            Aseguramiento
          </div>
          <div id="c4-terminal" class="terminal-box" style="border-color: var(--yellow);">
            <div class="term-line" id="c4-term1">&gt; forensic-cli isolate --servers bank-prod</div>
            <div class="term-line" id="c4-term2">&gt; STATUS: SERVERS ISOLATED FROM NETWORK (OK)</div>
            <div class="term-line" id="c4-term3">&gt; EVIDENCE PROTECTION MODE: DETECT & PROTECT</div>
          </div>
        </div>
      </div>
      ...
      <div id="c5" class="scene-wrap">
        ...
        <div class="scene-content">
          ...
          <div id="c5-progress-container" class="progress-bar-container">
            <div class="progress-bar-title">COPIA FORENSE BIT A BIT DE DISCOS</div>
            <div class="progress-bar-track">
              <div id="c5-bar" class="progress-bar-fill green"></div>
            </div>
            <div class="progress-bar-label" id="c5-hash-label">INTEGRIDAD HASH SHA-256 ASEGURADA</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 6 — Código Fuente (40.0–48.0s) ── -->
      <div id="c6" class="scene-wrap">
        ...
        <div class="scene-content">
          <div id="c6-badge" class="badge red">
            <span class="material-icons" style="font-size:32px;color:#ff3b30;">code</span>
            Código Fuente
          </div>
          <div id="c6-dashed-box" class="dashed-box" style="border-color: var(--red);">
            <div id="c6-label" class="meta-label-mono red">INSTRUCCIÓN MALICIOSA DETECTADA</div>
            <div style="font-family:'Share Tech Mono',monospace;font-size:20px;color:#ff3b30;">ROUNDING_UTILS.JS -> ALTERADO AUTOMÁTICO</div>
          </div>
        </div>
      </div>
      ...
      <div id="c7" class="scene-wrap">
        ...
        <div class="scene-content">
          ...
          <div id="c7-terminal" class="terminal-box" style="border-color: var(--green);">
            <div class="term-line" id="c7-term1">&gt; SENTENCIA: CULPABLE DE FRAUDE INFORMÁTICO</div>
            <div class="term-line" id="c7-term2">&gt; MEDIDA: ALTERACIÓN DE DATOS Y ROBO AUTOMATIZADO</div>
      ...
      <!-- ── POWER WORDS ── -->
      <div id="pw-container">
        <div id="pw-salami" class="pw red">ROBO SILENCIOSO</div>
        <div id="pw-auditoria" class="pw yellow">EVIDENCIA HASH</div>
        <div id="pw-falsificacion" class="pw green">FRAUDE FINANCIERO</div>
      </div>

      <!-- ── SOCIAL PROOFS ── -->
      <div id="sp-container">
        <div id="sp1" class="sp">LA TÉCNICA DEL SALAMI ES UN ROBO AUTOMATIZADO</div>
        <div id="sp2" class="sp">EL ASEGURAMIENTO PROTEGE LA INTEGRIDAD DIGITAL</div>
        <div id="sp3" class="sp">LOS ALGORITMOS HASH BLINDAN LAS IMÁGENES FORENSES</div>
      </div>

      <!-- ── AUDIO AUDIO TRACKS ── -->
      <!-- Background Music (Track 1) - Starting from offset 60.0s for varied drop rhythm -->
      <audio
        id="bg-music"
        class="clip"
        data-start="0.0"
...
${audioTags}
    ...
    <script>
      ...
      (function () {
        ...
        function drawVaultLock(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 8;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = alertColor;
          ctx.lineWidth = 4;
          roundRect(ctx, px, py, pw, ph, pr, true, true);

          // Draw the lock outer ring
          ctx.strokeStyle = "rgba(254, 207, 6, 0.35)"; // yellow dial ring
          ctx.lineWidth = 3;
          ctx.beginPath();
          ...
          ctx.strokeStyle = "rgba(254, 207, 6, 0.5)";
          ctx.lineWidth = 2;
          for (var i = 0; i < 40; i++) {
            var angle = (i * Math.PI) / 20;
            var tickLen = i % 5 === 0 ? 12 : 6;
            ctx.beginPath();
            ctx.moveTo(cx + Math.cos(angle) * 110, cy - 30 + Math.sin(angle) * 110);
            ctx.lineTo(cx + Math.cos(angle) * (110 - tickLen), cy - 30 + Math.sin(angle) * (110 - tickLen));
            ctx.stroke();
          }

          // Rotating central dial
          var rotation = time * 1.5;
          ctx.save();
          ...
          // Dial markers
          ctx.fillStyle = "rgba(254, 207, 6, 0.7)";
          ctx.font = "normal 11px 'Share Tech Mono'";
          for (var j = 0; j < 4; j++) {
            ctx.save();
            ctx.rotate((j * Math.PI) / 2);
            ctx.fillText(j * 25, -7, -50);
            ctx.restore();
          }

          // Mechanical lines inside dial
          ctx.strokeStyle = "rgba(254, 207, 6, 0.25)";
          ctx.beginPath();
          ...
          // Center handle
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = "rgba(254, 207, 6, 0.9)";
          ctx.beginPath();
          ctx.arc(cx, cy - 30, 25, 0, Math.PI * 2);
          ctx.fill();
          ctx.stroke();

          // Top index indicator arrow
          ctx.fillStyle = "rgba(255, 59, 48, 0.95)";
          ctx.beginPath();
          ctx.moveTo(cx, cy - 30 - 120);
          ctx.lineTo(cx - 8, cy - 30 - 132);
          ctx.lineTo(cx + 8, cy - 30 - 132);
          ctx.closePath();
          ctx.fill();
          ...
          ctx.fillText("SYS: SECURE VAULT ACCESS", px + 35, py + 45);

          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("MONITORING FRAUD ALARMS", px + 35, cy + 115);
          ctx.fillStyle = "rgba(254, 207, 6, 0.8)";
          ctx.fillText("STATUS: LOCK ARMED", px + 35, cy + 140);
        }

        function drawSalamiSlicing(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 8;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = alertColor;
          ctx.lineWidth = 4;
          ...
          ctx.fillText("SALAMI FRAUD SIMULATION", px + 35, py + 45);

          // Horizontal transactions stream pipe
          ctx.strokeStyle = "rgba(0, 255, 65, 0.2)";
          ctx.lineWidth = 6;
          ctx.beginPath();
          ctx.moveTo(px + 40, cy - 60);
          ctx.lineTo(px + pw - 40, cy - 60);
          ctx.stroke();

          // Draw floating packets moving horizontally
          var flowTime = (time * 60) % 240;
          for (var i = 0; i < 4; i++) {
            var packetX = px + 40 + ((flowTime + i * 70) % 280);
            ctx.fillStyle = "rgba(0, 255, 65, 0.85)";
            ctx.fillRect(packetX - 8, cy - 64, 16, 8);

            // Slicing event at center
            if (Math.abs(packetX - cx) < 25) {
              // Draw micro-slice dropping down
              var sliceY = cy - 50 + ((time * 80) % 110);
              ctx.fillStyle = "rgba(255, 59, 48, 0.95)";
              ctx.fillRect(cx - 3, sliceY, 6, 2);

              // Little neon sparks at slice point
              ctx.strokeStyle = "rgba(255, 59, 48, 0.8)";
              ctx.lineWidth = 1;
              ctx.beginPath();
              ctx.moveTo(cx - 10, cy - 60); ctx.lineTo(cx - 5, cy - 55);
              ctx.moveTo(cx + 10, cy - 60); ctx.lineTo(cx + 5, cy - 55);
              ctx.stroke();
            }
          }

          // Destination hacker account folder
          ctx.fillStyle = "rgba(20, 22, 22, 0.95)";
          ctx.strokeStyle = "rgba(255, 59, 48, 0.65)";
          ctx.lineWidth = 2;
          ctx.fillRect(cx - 60, cy + 60, 120, 70);
          ctx.strokeRect(cx - 60, cy + 60, 120, 70);

          // Tab of the folder
          ctx.fillRect(cx - 60, cy + 50, 45, 10);
          ctx.strokeRect(cx - 60, cy + 50, 45, 10);

          ctx.font = "normal 11px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(255, 59, 48, 0.9)";
          ctx.fillText("HACKER_FOLDER", cx - 45, cy + 85);
          ctx.fillText("SLICES RECORDED", cx - 45, cy + 105);

          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#ff3b30";
          ctx.fillText("TRANSACTION: RND_ROUNDING", px + 35, cy + 160);
        }

        function drawCoinHeap(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 8;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = "rgba(254, 207, 6, 0.5)"; // yellow theme
          ctx.lineWidth = 4;
          roundRect(ctx, px, py, pw, ph, pr, true, true);

          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(254, 207, 6, 0.9)";
          ctx.fillText("WEALTH ACCUMULATION", px + 35, py + 45);

          // Draw stacked coins columns growing in height
          var progress = (time - 16.0) / 8.0; // 0 to 1
          if (progress < 0) progress = 0;
          if (progress > 1) progress = 1;

          var cols = [
            { x: cx - 90, maxH: 14, coinColor: "rgba(254, 207, 6, 0.85)" },
            { x: cx - 30, maxH: 19, coinColor: "rgba(254, 207, 6, 0.95)" },
            { x: cx + 30, maxH: 22, coinColor: "rgba(254, 207, 6, 0.9)" },
            { x: cx + 90, maxH: 16, coinColor: "rgba(254, 207, 6, 0.8)" }
          ];

          for (var i = 0; i < cols.length; i++) {
            var col = cols[i];
            var currentCoins = Math.floor(col.maxH * progress);
            for (var c = 0; c < currentCoins; c++) {
              var cypos = cy + 120 - c * 8;
              ctx.fillStyle = col.coinColor;
              ctx.strokeStyle = "rgba(18, 20, 20, 0.6)";
              ctx.lineWidth = 1;
              
              // Draw ellipse/coin
              ctx.beginPath();
              ctx.ellipse(col.x, cypos, 22, 6, 0, 0, Math.PI * 2);
              ctx.fill();
              ctx.stroke();
            }
          }
          ...
          for (var p = 0; p < 8; p++) {
            var pSeed = seededRandom(p + 30);
            var pxpos = cx - 120 + pSeed * 240;
            var pypos = cy - 30 + ((time * 20 + pSeed * 100) % 150);
            ctx.fillStyle = "rgba(254, 207, 6, 0.6)";
            ctx.beginPath();
            ctx.arc(pxpos, cy + 120 - pypos, 2, 0, Math.PI * 2);
            ctx.fill();
          }

          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("ACCUMULATION RATIO: X1000", px + 35, cy + 150);
          ctx.fillStyle = "rgba(254, 207, 6, 0.85)";
          ctx.fillText("FUNDS: MICRO-CENT SYSTEM", px + 35, cy + 172);
        }

        function drawAseguramientoServers(time, alertColor, cx, cy) {
          // Draw server frame
          var px = cx - 130, py = cy - 220, pw = 260, ph = 440;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = "rgba(254, 207, 6, 0.6)"; // warning yellow theme
          ctx.lineWidth = 4;
          ...
          ctx.strokeStyle = "rgba(254, 207, 6, 0.15)";
          ctx.lineWidth = 1.5;
          for (var i = 0; i < numSlots; i++) {
            ...
            var flashYellow = Math.floor(time * 2 + i) % 3 === 0;
            ctx.fillStyle = flashYellow ? "rgba(254, 207, 6, 0.85)" : "rgba(80, 60, 0, 0.5)";
            ctx.beginPath();
            ctx.arc(px + 230, spy + slotHeight / 2, 5, 0, Math.PI * 2);
            ctx.fill();
          }

          // Forensic details text
          ctx.font = "normal 11px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(254, 207, 6, 0.9)";
          ctx.fillText("SYS: SECURING SERVER INSTANCE", px + 25, py + 30);
          ctx.fillText("DISK STATUS: LOCKED_READONLY", px + 25, py + 50);

          // Diagonally wrap yellow caution tape
          ctx.save();
          // Clip to server rectangle
          ctx.beginPath();
          ...
          for (var b = 0; b < bands.length; b++) {
            var by = bands[b];
            ctx.fillStyle = "rgba(254, 207, 6, 0.95)";
            ctx.strokeStyle = "rgba(18, 20, 20, 0.8)";
            ctx.lineWidth = 2;
            ctx.fillRect(-260, by, 520, 32);
            ctx.strokeRect(-260, by, 520, 32);

            // Draw black stripes
            ctx.fillStyle = "rgba(18, 20, 20, 0.85)";
            for (var sx = -260; sx < 260; sx += 35) {
              ctx.beginPath();
              ctx.moveTo(sx, by);
              ctx.lineTo(sx + 15, by);
              ctx.lineTo(sx + 5, by + 32);
              ctx.lineTo(sx - 10, by + 32);
              ctx.closePath();
              ctx.fill();
            }
          }
          ...
          ctx.fillStyle = "#ff3b30";
          ctx.fillText("ASEGURADO", cx - 40, cy + 130);
        }

        function drawHashCloner(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 12;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = "rgba(0, 255, 65, 0.5)"; // green theme
          ctx.lineWidth = 4;
          roundRect(ctx, px, py, pw, ph, pr, true, true);

          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(0, 255, 65, 0.9)";
          ctx.fillText("CLONING & HASH INTEGRITY", px + 30, py + 45);

          // Source / Target disks
          var leftDiskX = cx - 85;
          var rightDiskX = cx + 85;
          var diskY = cy - 35;

          var disks = [leftDiskX, rightDiskX];
          for (var d = 0; d < disks.length; d++) {
            var dx = disks[d];
            ctx.strokeStyle = "rgba(0, 255, 65, 0.25)";
            ctx.lineWidth = 2;
            ctx.beginPath();
            ctx.arc(dx, diskY, 55, 0, Math.PI * 2);
            ctx.stroke();

            ctx.beginPath();
            ctx.arc(dx, diskY, 15, 0, Math.PI * 2);
            ctx.stroke();

            var rot = time * (d === 0 ? 3.5 : 2.5);
            ctx.strokeStyle = "rgba(0, 255, 65, 0.5)";
            ctx.beginPath();
            ctx.moveTo(dx, diskY);
            ctx.lineTo(dx + Math.cos(rot) * 55, diskY + Math.sin(rot) * 55);
            ctx.stroke();
          }
          ...
          ctx.lineWidth = 3;
          ctx.beginPath();
          ctx.moveTo(leftDiskX + 60, diskY);
          ctx.lineTo(rightDiskX - 60, diskY);
          ctx.stroke();

          // Arrow head
          ctx.fillStyle = "rgba(0, 255, 65, 0.8)";
          ctx.beginPath();
          ctx.moveTo(rightDiskX - 60, diskY - 6);
          ctx.lineTo(rightDiskX - 52, diskY);
          ctx.lineTo(rightDiskX - 60, diskY + 6);
          ctx.closePath();
          ctx.fill();

          // Padlock in center
          ctx.strokeStyle = "rgba(0, 240, 255, 0.85)";
          ctx.fillStyle = "rgba(12, 15, 15, 0.95)";
          ctx.lineWidth = 2.5;
          ctx.fillRect(cx - 20, diskY - 30, 40, 32);
          ctx.strokeRect(cx - 20, diskY - 30, 40, 32);

          ctx.beginPath();
          ctx.arc(cx, diskY - 30, 13, Math.PI, 0);
          ctx.stroke();

          ctx.fillStyle = "rgba(0, 240, 255, 0.9)";
          ctx.font = "bold 9px 'Share Tech Mono'";
          ctx.fillText("HASH", cx - 12, diskY - 10);

          // Clone percentage
          var pct = Math.min(100, Math.floor(((time - 32.0) / 8.0) * 100));
          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("SRC_DRIVE -> IMAGEN_FORENSE", px + 30, cy + 85);
          ctx.fillText("DUP_STATUS: " + pct + "% COMPLETE", px + 30, cy + 108);

          var fl = Math.floor(time * 4) % 2 === 0;
          ctx.font = "bold 13px 'Share Tech Mono'";
          ctx.fillStyle = fl ? "rgba(0, 255, 65, 0.9)" : "rgba(0, 255, 65, 0.25)";
          ctx.fillText(">>> SHA-256 MATCH VERIFIED <<<", px + 30, cy + 140);
        }

        function drawCodeScanner(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 8;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = alertColor;
          ctx.lineWidth = 4;
          ...
          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(255, 59, 48, 0.9)";
          ctx.fillText("CODE AUDIT & SCANNING", px + 30, py + 45);

          // Code text lines
          var lines = [
            "function processTransaction(t) {",
            "  let amt = t.amount;",
            "  let round = amt.toFixed(2);",
            "  let diff = amt - round;",
            "  if (diff > 0) {",
            "    salami_bucket += diff; // HACK",
            "  }",
            "  return round;",
            "}"
          ];
          ...
          for (var i = 0; i < lines.length; i++) {
            ctx.fillText(lines[i], px + 30, startY + i * 22);
          }

          // Magnifier lens sliding
          var lensX = cx + Math.sin(time * 3) * 60;
          var lensY = cy + Math.cos(time * 2) * 40;
          var lensRad = 52;

          ctx.strokeStyle = "rgba(254, 207, 6, 0.85)";
          ctx.lineWidth = 3;
          ctx.beginPath();
          ctx.arc(lensX, lensY, lensRad, 0, Math.PI * 2);
          ctx.stroke();

          ctx.fillStyle = "rgba(254, 207, 6, 0.05)";
          ctx.beginPath();
          ctx.arc(lensX, lensY, lensRad, 0, Math.PI * 2);
          ctx.fill();

          ctx.strokeStyle = "rgba(254, 207, 6, 0.75)";
          ctx.lineWidth = 5;
          ctx.beginPath();
          ctx.moveTo(lensX + Math.cos(Math.PI/4) * lensRad, lensY + Math.sin(Math.PI/4) * lensRad);
          ctx.lineTo(lensX + Math.cos(Math.PI/4) * (lensRad + 25), lensY + Math.sin(Math.PI/4) * (lensRad + 25));
          ctx.stroke();

          // Clip to magnifying glass to draw red malicious lines
          ctx.save();
          ctx.beginPath();
          ctx.arc(lensX, lensY, lensRad, 0, Math.PI * 2);
          ctx.clip();
          ...
          for (var j = 0; j < lines.length; j++) {
            ctx.fillText(lines[j], px + 30, startY + j * 22);
          }
          ctx.restore();

          ctx.font = "bold 11px 'Share Tech Mono'";
          ctx.fillStyle = "#ff3b30";
          ctx.fillText("MALICIOUS LOGIC FOUND: ROUNDING_FRAUD", px + 30, cy + 155);
        }
        ...
        function drawJustice(time, alertColor, cx, cy) {
          ...
          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("CONDENA FRAUDE INFORM.", px + 25, cy + 90);
          ctx.fillStyle = "rgba(0, 255, 65, 0.9)";
          ctx.fillText("APLICANDO LEY PENAL", px + 25, cy + 115);
          ctx.fillText("ALTERACIÓN DE DATOS", px + 25, cy + 135);
        }

        function drawProtectedGraph(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 12;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = alertColor;
          ctx.lineWidth = 4;
          ...
          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(0, 255, 65, 0.9)";
          ctx.fillText("SECURE BANKING SYSTEM", px + 35, py + 45);

          // Draw grid inside card
          ctx.strokeStyle = "rgba(0, 255, 65, 0.08)";
          ctx.lineWidth = 1;
          for (var x = px + 30; x < px + pw - 30; x += 30) {
            ctx.beginPath(); ctx.moveTo(x, cy - 80); ctx.lineTo(x, cy + 100); ctx.stroke();
          }
          for (var y = cy - 80; y < cy + 100; y += 30) {
            ctx.beginPath(); ctx.moveTo(px + 30, y); ctx.lineTo(px + pw - 30, y); ctx.stroke();
          }

          // Financial line graph going up
          ctx.strokeStyle = "rgba(0, 255, 65, 0.4)";
          ctx.lineWidth = 2.5;
          ctx.beginPath();
          ctx.moveTo(px + 30, cy + 60);
          ctx.lineTo(cx - 60, cy + 30);
          ctx.lineTo(cx, cy + 50);
          ctx.lineTo(cx + 60, cy - 20);
          ctx.lineTo(px + pw - 30, cy - 40);
          ctx.stroke();

          // Concentric protection circles
          var radius1 = 110 + Math.sin(time * 4) * 5;
          var radius2 = 125 + Math.cos(time * 3) * 3;

          ctx.strokeStyle = "rgba(0, 240, 255, 0.5)";
          ctx.lineWidth = 2;
          ctx.beginPath();
          ctx.arc(cx, cy, radius1, 0, Math.PI * 2);
          ctx.stroke();
          ...
          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("SECURITY: SHIELD INTACT", px + 35, cy + 138);
          ctx.fillStyle = "rgba(0, 240, 255, 0.85)";
          ctx.fillText("MONITORING RECURRING AUDITS", px + 35, cy + 160);
        }
        ...
        function drawForensicSimulation(time) {
          ...
          var alertColor = "rgba(0, 255, 65, 0.35)";
          if (time >= 0.0 && time < 16.0) {
            alertColor = "rgba(255, 59, 48, 0.5)"; // alert state red
          } else if (time >= 40.0 && time < 48.0) {
            alertColor = "rgba(255, 59, 48, 0.5)";
          } else if (time >= 48.0 && time < 56.0) {
            alertColor = "rgba(0, 255, 65, 0.75)";
          }

          // Routing Canvas elements per scene
          if (time < 8.0) {
            drawVaultLock(time, alertColor, cx, cy);
          } else if (time >= 8.0 && time < 16.0) {
            drawSalamiSlicing(time, alertColor, cx, cy);
          } else if (time >= 16.0 && time < 24.0) {
            drawCoinHeap(time, alertColor, cx, cy);
          } else if (time >= 24.0 && time < 32.0) {
            drawAseguramientoServers(time, alertColor, cx, cy);
          } else if (time >= 32.0 && time < 40.0) {
            drawHashCloner(time, alertColor, cx, cy);
          } else if (time >= 40.0 && time < 48.0) {
            drawCodeScanner(time, alertColor, cx, cy);
          } else if (time >= 48.0 && time < 56.0) {
            drawJustice(time, alertColor, cx, cy);
          } else {
            drawProtectedGraph(time, alertColor, cx, cy);
          }
      ...
      // Transition 5 (c5 -> c6 at 40.0s): Staggered Blocks
      tl.to("#sha256-v09", { x: 20, y: -20, duration: 0.04, ease: "none", repeat: 4, yoyo: true }, 39.85);
      tl.to("#sha256-v09", { x: 0, y: 0, duration: 0.05, ease: "none" }, 40.06);
      tl.to("#sha256-v09", { filter: "invert(0.9) sepia(1) saturate(3) hue-rotate(320deg)", duration: 0.08, ease: "none" }, 39.85);
      tl.to("#sha256-v09", { filter: "none", duration: 0.15, ease: "power2.out" }, 39.93);
      ...
      tl.to("#sha256-v09", { filter: "blur(20px) contrast(1.4)", scale: 1.12, duration: 0.16, ease: "power2.in" }, 55.84);
      tl.to("#sha256-v09", { filter: "none", scale: 1.0, duration: 0.25, ease: "power3.out" }, 56.0);
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 2 — Fraude Digital (t = 8.0–16.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c2-bg",
        { scale: 1.2, x: 25, y: 15 },
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 3 — Desvío Micro (t = 16.0–24.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c3-bg",
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 4 — Aseguramiento (t = 24.0–32.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c4-bg",
        { scale: 1.2, x: -25, y: 20 },
      ...
      tl.from("#c4-terminal", { scaleY: 0, opacity: 0, duration: 0.5, ease: "expo.out" }, 24.4);
      
      tl.to("#c4-term1", { opacity: 1, duration: 0.1 }, 25.2);
      tl.to("#c4-term2", { opacity: 1, duration: 0.1 }, 26.5);
      tl.to("#c4-term3", { opacity: 1, duration: 0.1 }, 28.2);
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 6 — Código Fuente (t = 40.0–48.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c6-bg",
        { scale: 1.2, x: 15, y: -25 },
      ...
      // Fade composition to black at the end
      tl.to("#sha256-v09", { opacity: 0, duration: 0.6, ease: "power2.in" }, 63.4);

      /* ─────────────────────────────────────────────────────
         POWER WORDS TIMING
         ───────────────────────────────────────────────────── */
      // PW1: "ROBO SILENCIOSO" (t = 6.2s to 7.8s)
      tl.set("#pw-salami", { visibility: "visible" }, 6.2);
      tl.to("#pw-salami", { opacity: 1, scale: 1, duration: 0.15, ease: "back.out(2)" }, 6.2);
      tl.to("#pw-salami", { opacity: 0, scale: 0.9, duration: 0.15, ease: "power2.in" }, 7.6);
      tl.set("#pw-salami", { opacity: 0, visibility: "hidden" }, 7.75);

      // PW2: "EVIDENCIA HASH" (t = 21.0s to 23.0s)
      tl.set("#pw-auditoria", { visibility: "visible" }, 21.0);
      tl.to("#pw-auditoria", { opacity: 1, scale: 1, duration: 0.15, ease: "back.out(2)" }, 21.0);
      tl.to("#pw-auditoria", { opacity: 0, scale: 0.9, duration: 0.15, ease: "power2.in" }, 22.8);
      tl.set("#pw-auditoria", { opacity: 0, visibility: "hidden" }, 22.95);

      // PW3: "FRAUDE FINANCIERO" (t = 44.5s to 46.8s)
      tl.set("#pw-falsificacion", { visibility: "visible" }, 44.5);
      tl.to("#pw-falsificacion", { opacity: 1, scale: 1, duration: 0.15, ease: "back.out(2)" }, 44.5);
      tl.to("#pw-falsificacion", { opacity: 0, scale: 0.9, duration: 0.15, ease: "power2.in" }, 46.5);
      tl.set("#pw-falsificacion", { opacity: 0, visibility: "hidden" }, 46.65);
      ...
      /* ─────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────── */
      window.__timelines["sha256-v09"] = tl;
    </script>
  </body>
</html>
`;
...
const destDir = path.join(ROOT_DIR, "videos", "sha256-v09");
...
console.log("videos/sha256-v09/index.html generado exitosamente!");
