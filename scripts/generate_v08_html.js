...
<!-- sha256-v08 · SHA256.US Laboratorio Forense · 64s · 1080x1920 · 30fps -->
<html lang="es">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div
      id="sha256-v08"
      data-composition-id="sha256-v08"
      data-width="1080"
      data-height="1920"
      data-start="0"
      data-duration="64.0"
...
${audioTags}
    ...
    <script>
      ...
      tl.to("#sha256-v08", { x: 20, y: -20, duration: 0.04, ease: "none", repeat: 4, yoyo: true }, 39.85);
      tl.to("#sha256-v08", { x: 0, y: 0, duration: 0.05, ease: "none" }, 40.06);
      tl.to("#sha256-v08", { filter: "invert(0.9) sepia(1) saturate(3) hue-rotate(320deg)", duration: 0.08, ease: "none" }, 39.85);
      tl.to("#sha256-v08", { filter: "none", duration: 0.15, ease: "power2.out" }, 39.93);
      ...
      tl.to("#sha256-v08", { filter: "blur(20px) contrast(1.4)", scale: 1.12, duration: 0.16, ease: "power2.in" }, 55.84);
      tl.to("#sha256-v08", { filter: "none", scale: 1.0, duration: 0.25, ease: "power3.out" }, 56.0);
      ...
      tl.to("#sha256-v08", { opacity: 0, duration: 0.6, ease: "power2.in" }, 63.4);
      ...
      /* ─────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────── */
      window.__timelines["sha256-v08"] = tl;
    </script>
  </body>
</html>
`;
...
const destDir = path.join(ROOT_DIR, "videos", "sha256-v08");
...
console.log("videos/sha256-v08/index.html generado exitosamente!");
