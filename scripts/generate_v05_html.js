...
const CLIPS = [
  {
    ...
    icon: "warning",
    badgeClass: "yellow",
    text: "En Venezuela, un gerente enfrentó graves cargos cuando una empleada usó la Ley de la Mujer para acusarlo de acoso sexual mediante chats.",
    title: "FALSA ACUSACIÓN",
    question: "¿Fórmula legal instrumentalizada?",
    reveal: "Chats fabricados",
    isHook: true,
  },
  {
    id: "c2",
    start: 8.0,
    duration: 8.0,
    badge: "Falsa Evidencia",
    icon: "phone_android",
    badgeClass: "red",
    text: "Como prueba, ella consignó voluntariamente su teléfono ante la Fiscalía, mostrando conversaciones de WhatsApp donde él presuntamente le exigía favores íntimos.",
  },
  {
    id: "c3",
    start: 16.0,
    duration: 8.0,
    badge: "Extracción Física",
    icon: "developer_board",
    badgeClass: "yellow",
    text: "El tribunal ordenó al Centro Nacional de Informática Forense, el CENIF, realizar una extracción física del dispositivo móvil aplicando el estricto protocolo MUCCEF.",
  },
  {
    id: "c4",
    start: 24.0,
    duration: 8.0,
    badge: "Integridad Hash",
    icon: "lock",
    badgeClass: "green",
    text: "Los peritos extrajeron las bases de datos con herramientas avanzadas y aplicaron algoritmos Hash para garantizar la inalterabilidad legal de la evidencia.",
  },
  {
    id: "c5",
    start: 32.0,
    duration: 8.0,
    badge: "Análisis SQLite",
    icon: "analytics",
    badgeClass: "red",
    text: "Al analizar el código interno, descubrieron el fraude. Los mensajes no pasaron por los servidores reales y carecían de firmas criptográficas legítimas.",
  },
  {
    id: "c6",
    start: 40.0,
    duration: 8.0,
    badge: "Simulación de App",
    icon: "dangerous",
    badgeClass: "red",
    text: "El peritaje reveló que ella utilizó una aplicación de terceros para fabricar conversaciones falsas y simular el perfil del gerente a la perfección.",
  },
  {
    id: "c7",
    start: 48.0,
    ...
    icon: "gavel",
    badgeClass: "green",
    text: "Ante la prueba forense irrefutable, el juez absolvió inmediatamente al acusado e imputó a la mujer por simulación de hecho punible y perjurio.",
  },
  {
    id: "c8",
    start: 56.0,
    duration: 8.0,
    badge: "Lección Forense",
    icon: "fingerprint",
    badgeClass: "green",
    text: "La lección: fabricar evidencia digital deja rastros imborrables. La informática forense no miente. ¡Protege tus derechos, guarda y comparte este video!",
    isCloser: true,
  },
];
...
CLIPS.forEach((clip, cIdx) => {
  ...
  // We'll skip word pops for very short words (< 3 chars) or space them slightly to avoid too dense popping
...
<!-- sha256-v05 · SHA256.US Laboratorio Forense · 64s · 1080x1920 · 30fps -->
<html lang="es">
  <head>
    <meta charset="UTF-8" />
    <title>SHA256.US — Chats Falsos: El Caso de la Falsa Acusación</title>
    <!-- Material Icons -->
  ...
  <body>
    <div
      id="sha256-v05"
      data-composition-id="sha256-v05"
      data-width="1080"
      data-height="1920"
      data-start="0"
      data-duration="64.0"
    >
      ...
      <div id="c1" class="scene-wrap">
        <div class="bg-layer">
          <img id="c1-bg" src="images/clip-1.png" alt="" crossorigin="anonymous" />
        ...
        <div class="hook-wrap">
          ...
          <div id="c1-warn" class="hook-warn-label">
            ...
            Caso Forense · Venezuela
          </div>
          <div id="c1-title" class="hook-title">FALSA ACUSACIÓN</div>
          <div id="c1-line" class="hook-line"></div>
        </div>
      </div>

      <!-- ── SCENE 2 — Evidencia (8.0–16.0s) ── -->
      <div id="c2" class="scene-wrap">
        <div class="bg-layer">
          <img id="c2-bg" src="images/clip-2.png" alt="" crossorigin="anonymous" />
          <div class="bg-overlay"></div>
        </div>
        <div class="scene-content">
          <div id="c2-dashed-box" class="dashed-box">
            <div id="c2-badge" class="badge red">
              <span class="material-icons" style="font-size:32px;color:#ff3b30;">phone_android</span>
              Falsa Evidencia
            </div>
            <div id="c2-label" class="meta-label-mono red">CHATS DE WHATSAPP CONSIGNADOS</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 3 — Orden Judicial (16.0–24.0s) ── -->
      <div id="c3" class="scene-wrap">
        <div class="bg-layer">
          <img id="c3-bg" src="images/clip-3.png" alt="" crossorigin="anonymous" />
          <div class="bg-overlay"></div>
        </div>
        <div class="scene-content">
          ...
          <div id="c3-progress-container" class="progress-bar-container">
            <div class="progress-bar-title">PROTOCOLO FORENSE MUCCEF EN CENIF</div>
            <div class="progress-bar-track">
              <div id="c3-bar" class="progress-bar-fill green"></div>
            </div>
            <div class="progress-bar-label" id="c3-progress-label">CONEXIÓN FÍSICA ESTABLECIDA</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 4 — Integridad Hash (24.0–32.0s) ── -->
      <div id="c4" class="scene-wrap">
        <div class="bg-layer">
          <img id="c4-bg" src="images/clip-4.png" alt="" crossorigin="anonymous" />
          <div class="bg-overlay"></div>
        </div>
        <div class="scene-content">
          ...
          <div id="c4-progress-container" class="progress-bar-container">
            <div class="progress-bar-title">GARANTÍA DE INALTERABILIDAD LEGAL</div>
            <div class="progress-bar-track">
              <div id="c4-bar" class="progress-bar-fill green"></div>
            </div>
            <div class="progress-bar-label" id="c4-hash-label">HASH SHA-256 GENERADO</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 5 — Análisis SQLite (32.0–40.0s) ── -->
      <div id="c5" class="scene-wrap">
        <div class="bg-layer">
          <img id="c5-bg" src="images/clip-5.png" alt="" crossorigin="anonymous" />
          <div class="bg-overlay"></div>
        </div>
        <div class="scene-content">
          ...
          <div id="c5-terminal" class="terminal-box">
            <div class="term-line" id="c5-term1">&gt; SELECT * FROM message WHERE key_from_me = 1...</div>
            <div class="term-line red" id="c5-term2">&gt; ERROR: MISSING SERVER CRYPTOGRAPHIC SIGNATURES</div>
            <div class="term-line" id="c5-term3">&gt; TRACE: LOCAL DATABASE INJECTED VIA SPARKLE APP</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 6 — Suplantación (40.0–48.0s) ── -->
      <div id="c6" class="scene-wrap">
        <div class="bg-layer">
          <img id="c6-bg" src="images/clip-6.png" alt="" crossorigin="anonymous" />
          <div class="bg-overlay"></div>
        </div>
        <div class="scene-content">
          <div id="c6-badge" class="badge red">
            <span class="material-icons" style="font-size:32px;color:#ff3b30;">dangerous</span>
            Chats Fabricados
          </div>
          <div id="c6-dashed-box" class="dashed-box" style="border-color: var(--red);">
            <div id="c6-label" class="meta-label-mono red">APLICACIÓN DE TERCEROS DETECTADA</div>
            <div style="font-family:'Share Tech Mono',monospace;font-size:22px;color:#ff3b30;">CLONACIÓN DE PERFIL CON FAKE-CHAT BUILDER</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 7 — Absolución (48.0–56.0s) ── -->
      <div id="c7" class="scene-wrap">
        <div class="bg-layer">
          <img id="c7-bg" src="images/clip-7.png" alt="" crossorigin="anonymous" />
          <div class="bg-overlay"></div>
        </div>
        <div class="scene-content">
          <div id="c7-badge" class="badge green">
            <span class="material-icons" style="font-size:32px;color:#00ff41;">gavel</span>
            Absolución e Imputación
          </div>
          <div id="c7-terminal" class="terminal-box" style="border-color: var(--green);">
            <div class="term-line" id="c7-term1">&gt; ACUSADO: ABSUELTO INMEDIATAMENTE</div>
            <div class="term-line red" id="c7-term2">&gt; IMPUTADA: SIMULACIÓN DE HECHO PUNIBLE</div>
            <div class="term-line" id="c7-term3">&gt; IMPUTADA: DELITO DE PERJURIO CONTRATADO</div>
          </div>
        </div>
      </div>
      ...
      <div id="c8" class="scene-wrap">
        <div class="bg-layer">
          <img id="c8-bg" src="images/clip-8.png" alt="" crossorigin="anonymous" />
          <div class="bg-overlay"></div>
        </div>
        <div class="closer-wrap">
          <div id="c8-label" class="closer-label">
            <span class="material-icons" style="font-size:32px;color:#00ff41;">fingerprint</span>
      ...
      <!-- ── POWER WORDS ── -->
      <div id="pw-container">
        <div id="pw-falsos" class="pw red">CHATS FALSOS</div>
        <div id="pw-fraude" class="pw red">FRAUDE DETECTADO</div>
        <div id="pw-perjurio" class="pw yellow">PERJURIO</div>
      </div>

      <!-- ── SOCIAL PROOFS ── -->
      <div id="sp-container">
        <div id="sp1" class="sp">EXTRACCIÓN COMPLETA BAJO PROTOCOLO DE LEY MUCCEF</div>
        <div id="sp2" class="sp">LAS BASES DE DATOS SQLITE NO TIENEN FIRMA REAL</div>
        <div id="sp3" class="sp">SIMULACIÓN DE HECHO PUNIBLE TIENE PENA DE CÁRCEL</div>
      </div>
    ...
    <script>
      ...
      (function () {
        ...
        function drawForensicSimulation(time) {
          ...
          if (time < 8.0) {
            // Screen 1: Balance scale / legal warn
            ctx.font = "normal 18px 'Share Tech Mono'";
            ctx.fillStyle = "rgba(0, 255, 65, 0.8)";
            ctx.fillText("SYS: INIT FORENSICS", px + 30, py + 50);
            
            // Draw scale symbol
            ctx.font = "70px sans-serif";
            ctx.fillStyle = "rgba(254, 207, 6, 0.75)";
            ctx.fillText("⚖", cx - 35, cy - 10);
            
            ctx.font = "normal 14px 'Share Tech Mono'";
            ctx.fillStyle = "#e2e2e2";
            ctx.fillText("ATTRIB: LEY DE MUJER", px + 40, cy + 100);
            ctx.fillText("STATUS: ACCUSATION", px + 40, cy + 130);
            
          } else if (time >= 8.0 && time < 16.0) {
            // Screen 2: WhatsApp chat layout showing bubbles
            ctx.font = "normal 14px 'Share Tech Mono'";
            ctx.fillStyle = "rgba(0, 255, 65, 0.6)";
            ctx.fillText("WhatsApp SecureDB v2", px + 25, py + 40);
            
            // Draw bubble 1 (incoming)
            ctx.fillStyle = "rgba(255,255,255,0.06)";
            roundRect(ctx, px + 20, py + 80, 180, 50, 10, true, false);
            ctx.fillStyle = "#e2e2e2";
            ctx.font = "italic 11px 'Ubuntu'";
            ctx.fillText("¿Cuándo nos vemos?", px + 35, py + 100);
            ctx.fillText("exigía favores...", px + 35, py + 115);

            // Draw bubble 2 (outgoing)
            ctx.fillStyle = "rgba(0, 255, 65, 0.15)";
            roundRect(ctx, px + 80, py + 150, 180, 50, 10, true, false);
            ctx.fillStyle = "#e2e2e2";
            ctx.fillText("Hola, te espero en...", px + 95, py + 170);
            ctx.fillText("firmas: OK (LOCAL)", px + 95, py + 185);
            ...
            ctx.fillText("UNVERIFIED", cx - 35, cy + 55);
            ...
            ctx.font = "normal 14px 'Share Tech Mono'";
            ctx.fillStyle = "#e2e2e2";
            ctx.fillText("MUCCEF BLOCK READS", px + 40, cy + 40);
            ...
            ctx.fillText("INTEGRITY SECURED", px + 35, py + 50);
            ...
            ctx.fillText("9F86D081884C7D659A2FEAA0C55AD015", px + 25, cy + 105);
            ctx.fillText("A3EEF69286A2D407519E870D189178C9", px + 25, cy + 125);

          } else if (time >= 32.0 && time < 40.0) {
            // Screen 5: SQLite Database Analysis (Shatter check)
            ctx.font = "normal 16px 'Share Tech Mono'";
            ctx.fillStyle = "rgba(255, 59, 48, 0.9)";
            ctx.fillText("DB CODE CHECK...", px + 35, py + 50);

            ctx.font = "normal 12px 'Share Tech Mono'";
            ctx.fillStyle = "#e2e2e2";
            ctx.fillText("SELECT signature, server_time", px + 20, cy - 40);
            ctx.fillText("FROM chat_messages;", px + 20, cy - 20);
            
            // Fails flashing
            var flash = Math.floor(time * 4) % 2 === 0;
            ctx.font = "bold 16px 'Share Tech Mono'";
            ctx.fillStyle = flash ? "rgba(255, 59, 48, 0.9)" : "rgba(255, 59, 48, 0.2)";
            ctx.fillText(">>> NO SERVER SIG <<<", px + 30, cy + 40);
            ctx.fillText(">>> DATABASE INJECT <<<", px + 25, cy + 70);

            ctx.font = "normal 12px 'Share Tech Mono'";
            ctx.fillStyle = "rgba(0, 255, 65, 0.5)";
            ctx.fillText("EXPECTED RSA SIGNATURES", px + 30, cy + 130);
            ctx.fillText("FOUND: NULL / EMPTY", px + 30, cy + 155);

          } else if (time >= 40.0 && time < 48.0) {
            // Screen 6: Third party app spoof
            ctx.font = "normal 18px 'Share Tech Mono'";
            ctx.fillStyle = "rgba(255, 59, 48, 0.95)";
            ctx.fillText("SPOOF APP DETECTED", px + 35, py + 50);

            // Draw database nodes with lines (shattered)
            ...
            ctx.fillText("GENERATOR: FakeChatApp v3", px + 30, cy + 150);

          } else if (time >= 48.0 && time < 56.0) {
            // Screen 7: Absolved verdict
            ctx.font = "normal 18px 'Share Tech Mono'";
            ctx.fillStyle = "rgba(0, 255, 65, 0.95)";
            ctx.fillText("VERDICT: ABSOLVED", px + 35, py + 50);
            ...
            ctx.fillStyle = "#e2e2e2";
            ctx.fillText("ACUSADO ABSUELTO", px + 45, cy + 80);
            ctx.fillStyle = "rgba(255, 59, 48, 0.9)";
            ctx.fillText("PROCESO POR PERJURIO", px + 35, cy + 110);
            ctx.fillText("Y SIMULACIÓN DE HECHO", px + 35, cy + 130);

          } else {
            // Screen 8: Outro CTA Fingerprint
            ctx.font = "normal 18px 'Share Tech Mono'";
            ctx.fillStyle = "rgba(0, 255, 65, 0.8)";
            ctx.fillText("SHA256.US SECURE", px + 35, py + 50);

            // Fingerprint emoji / symbol
            ctx.font = "80px sans-serif";
            ctx.fillStyle = "rgba(0, 255, 65, 0.75)";
            ctx.fillText("👤", cx - 40, cy + 10);

            ctx.font = "normal 13px 'Share Tech Mono'";
            ctx.fillStyle = "#e2e2e2";
            ctx.fillText("INFORMÁTICA FORENSE", px + 40, cy + 90);
            ctx.fillText("PROTEGE TU IDENTIDAD", px + 40, cy + 115);
          }
      ...
      (function() {
        ...
        function updateCaptions(time) {
          ...
          if (currentClipIndex !== -1) {
            ...
            var chunkIndex = Math.floor(activeWordIndex / 3);
            var container = document.getElementById("captions-container");
            ...
            if (chunkIndex !== currentChunkIndex) {
              ...
              var startWordIdx = chunkIndex * 3;
              var endWordIdx = Math.min(startWordIdx + 3, numWords);
      ...
      tl.to("#sha256-v05", { x: 20, y: -20, duration: 0.04, ease: "none", repeat: 4, yoyo: true }, 31.85);
      tl.to("#sha256-v05", { x: 0, y: 0, duration: 0.05, ease: "none" }, 32.06);
      tl.to("#sha256-v05", { filter: "invert(0.9) sepia(1) saturate(3) hue-rotate(320deg)", duration: 0.08, ease: "none" }, 31.85);
      tl.to("#sha256-v05", { filter: "none", duration: 0.15, ease: "power2.out" }, 31.93);
      ...
      tl.to("#sha256-v05", { filter: "blur(20px) contrast(1.4)", scale: 1.12, duration: 0.16, ease: "power2.in" }, 55.84);
      tl.to("#sha256-v05", { filter: "none", scale: 1.0, duration: 0.25, ease: "power3.out" }, 56.0);
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 3 — Orden Judicial (t = 16.0–24.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c3-bg",
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 4 — Integridad Hash (t = 24.0–32.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c4-bg",
        { scale: 1.2, x: -25, y: 20 },
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 5 — Análisis SQLite (t = 32.0–40.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c5-bg",
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 6 — Suplantación (t = 40.0–48.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c6-bg",
        { scale: 1.2, x: 15, y: -25 },
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 7 — Absolución (t = 48.0–56.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c7-bg",
      ...
      tl.to("#sha256-v05", { opacity: 0, duration: 0.6, ease: "power2.in" }, 63.4);

      /* ─────────────────────────────────────────────────────
         POWER WORDS TIMING
         ───────────────────────────────────────────────────── */
      // PW1: "CHATS FALSOS" (t = 11.5s to 12.8s)
      tl.set("#pw-falsos", { visibility: "visible" }, 11.5);
      tl.to("#pw-falsos", { opacity: 1, scale: 1, duration: 0.15, ease: "back.out(2)" }, 11.5);
      tl.to("#pw-falsos", { opacity: 0, scale: 0.9, duration: 0.15, ease: "power2.in" }, 12.6);
      tl.set("#pw-falsos", { visibility: "hidden" }, 12.8);

      // PW2: "FRAUDE DETECTADO" (t = 35.5s to 37.0s)
      tl.set("#pw-fraude", { visibility: "visible" }, 35.5);
      tl.to("#pw-fraude", { opacity: 1, scale: 1, duration: 0.15, ease: "back.out(2)" }, 35.5);
      tl.to("#pw-fraude", { opacity: 0, scale: 0.9, duration: 0.15, ease: "power2.in" }, 36.8);
      tl.set("#pw-fraude", { visibility: "hidden" }, 37.0);

      // PW3: "PERJURIO" (t = 51.5s to 53.0s)
      tl.set("#pw-perjurio", { visibility: "visible" }, 51.5);
      tl.to("#pw-perjurio", { opacity: 1, scale: 1, duration: 0.15, ease: "back.out(2)" }, 51.5);
      tl.to("#pw-perjurio", { opacity: 0, scale: 0.9, duration: 0.15, ease: "power2.in" }, 52.8);
      tl.set("#pw-perjurio", { visibility: "hidden" }, 53.0);
      ...
      /* ─────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────── */
      window.__timelines["sha256-v05"] = tl;
    </script>
  </body>
</html>
`;
...
const destDir = path.join(ROOT_DIR, "videos", "sha256-v05");
...
console.log("videos/sha256-v05/index.html generado exitosamente!");
