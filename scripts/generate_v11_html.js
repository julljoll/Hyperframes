...
const CLIPS = [
  {
    ...
    icon: "warning",
    badgeClass: "red",
    text: "Un joven hizo clic en un enlace viral de TikTok que prometía filtros exclusivos. En realidad, descargó un troyano para robo de datos.",
    title: "TIKTOK PHISHING",
    question: "¿Enlace Malicioso?",
    reveal: "Troyano Descargado",
    isHook: true,
  },
  {
    id: "c2",
    ...
    icon: "visibility_off",
    badgeClass: "red",
    text: "El software malicioso operó en silencio, extrayendo contraseñas bancarias y fotografías íntimas directamente desde su smartphone sin encender ninguna alarma de seguridad.",
  },
  {
    id: "c3",
    start: 16.0,
    ...
    icon: "security",
    badgeClass: "yellow",
    text: "Tras el millonario robo, la víctima denunció. Peritos informáticos aislaron inmediatamente el celular en una bolsa de Faraday para evitar el borrado remoto.",
  },
  {
    id: "c4",
    start: 24.0,
    ...
    badgeClass: "yellow",
    text: "Aplicando normativas internacionales, los expertos realizaron una extracción física de la memoria del dispositivo móvil usando herramientas forenses avanzadas como MSAB XRY.",
  },
  {
    id: "c5",
    start: 32.0,
    ...
    icon: "analytics",
    badgeClass: "red",
    text: "El peritaje informático sobre la memoria volátil y bases de datos descubrió el código malicioso, vinculándolo directamente al perfil falso de TikTok.",
  },
  {
    id: "c6",
    start: 40.0,
    ...
    icon: "fingerprint",
    badgeClass: "green",
    text: "Los investigadores analizaron el código fuente de la red social, obteniendo el ID único del cibercriminal y sus registros de conexión IP.",
  },
  {
    id: "c7",
    start: 48.0,
    ...
    icon: "gavel",
    badgeClass: "red",
    text: "Gracias a la cooperación judicial internacional, rastrearon al atacante. Fue capturado y condenado a prisión por fraude informático y espionaje de datos.",
  },
  {
    id: "c8",
    start: 56.0,
    ...
    icon: "share",
    badgeClass: "green",
    text: "La lección legal: los enlaces virales en redes sociales pueden ser trampas letales. ¡Protege tu identidad digital, guarda y comparte este video!",
    isCloser: true,
  },
];
...
<!-- sha256-v11 · SHA256.US Laboratorio Forense · 64s · 1080x1920 · 30fps -->
<html lang="es">
  <head>
    <meta charset="UTF-8" />
    <title>SHA256.US — Phishing en TikTok y Troyano Bancario</title>
    <!-- Material Icons -->
  ...
  <body>
    <div
      id="sha256-v11"
      data-composition-id="sha256-v11"
      data-width="1080"
      data-height="1920"
      data-start="0"
      data-duration="64.0"
    >
      ...
      <div id="c1" class="scene-wrap">
        ...
        <div class="hook-wrap">
          ...
          <div id="c1-title" class="hook-title">ENLACE VIRAL</div>
          <div id="c1-line" class="hook-line"></div>
        </div>
      </div>

      <!-- ── SCENE 2 — Infección (8.0–16.0s) ── -->
      <div id="c2" class="scene-wrap">
        ...
        <div class="scene-content">
          <div id="c2-dashed-box" class="dashed-box" style="border-color: var(--red);">
            ...
            <div id="c2-label" class="meta-label-mono red">EXTRACCIÓN SILENCIOSA DE DATOS</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 3 — Aislamiento (16.0–24.0s) ── -->
      <div id="c3" class="scene-wrap">
        ...
        <div class="scene-content">
          <div id="c3-badge" class="badge">
            <span class="material-icons" style="font-size:32px;color:#fecf06;">security</span>
            Aislamiento
          </div>
          <div id="c3-progress-container" class="progress-bar-container">
            <div class="progress-bar-title">BOLSA DE FARADAY ACTIVA</div>
            <div class="progress-bar-track">
              <div id="c3-bar" class="progress-bar-fill red"></div>
            </div>
            <div class="progress-bar-label">BLOQUEANDO SEÑALES ELECTROMAGNÉTICAS</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 4 — Extracción (24.0–32.0s) ── -->
      <div id="c4" class="scene-wrap">
        ...
        <div class="scene-content">
          <div id="c4-badge" class="badge red">
            <span class="material-icons" style="font-size:32px;color:#ff3b30;">phonelink_setup</span>
            Extracción
          </div>
          <div id="c4-terminal" class="terminal-box" style="border-color: var(--yellow);">
            <div class="term-line" id="c4-term1">&gt; xry-extractor --device physical-dump --out /evidence/</div>
            <div class="term-line" id="c4-term2">&gt; DUMPING PARTITIONS: SYSTEM_A, USERDATA</div>
            <div class="term-line" id="c4-term3">&gt; EXTRACTION STATUS: SUCCESSFUL PHYSICAL ACQUISITION</div>
          </div>
        </div>
      </div>
      ...
      <div id="c5" class="scene-wrap">
        ...
        <div class="scene-content">
          ...
          <div id="c5-progress-container" class="progress-bar-container" style="border-color: var(--red);">
            <div class="progress-bar-title">ANÁLISIS DE BASES DE DATOS & MEMORIA</div>
            <div class="progress-bar-track">
              <div id="c5-bar" class="progress-bar-fill red"></div>
            </div>
            <div class="progress-bar-label" id="c5-hash-label">IDENTIFICANDO VECTOR DE CARGA ÚTIL DE TIKTOK</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 6 — Rastreo OSINT (40.0–48.0s) ── -->
      <div id="c6" class="scene-wrap">
        ...
        <div class="scene-content">
          ...
          <div id="c6-dashed-box" class="dashed-box" style="border-color: var(--green);">
            <div id="c6-label" class="meta-label-mono green">ID DE USUARIO CRIMINAL DETECTADO</div>
            <div style="font-family:'Share Tech Mono',monospace;font-size:20px;color:#00ff41;">USER_ID: 7421890382 | IP: 185.120.4.82</div>
          </div>
        </div>
      </div>

      <!-- ── SCENE 7 — Captura (48.0–56.0s) ── -->
      <div id="c7" class="scene-wrap">
        ...
        <div class="scene-content">
          ...
          <div id="c7-terminal" class="terminal-box" style="border-color: var(--red);">
            <div class="term-line" id="c7-term1">&gt; ORDEN DE DETENCIÓN INTERNACIONAL EJECUTADA</div>
            <div class="term-line" id="c7-term2">&gt; CARGOS: FRAUDE BANCARIO Y ESPIONAJE DE DATOS</div>
            <div class="term-line" id="c7-term3">&gt; SENTENCIA: PENA DE PRISIÓN FIRME</div>
          </div>
        </div>
      </div>
      ...
      <!-- ── POWER WORDS ── -->
      <div id="pw-container">
        <div id="pw-salami" class="pw red">TROYANO BANCARIO</div>
        <div id="pw-auditoria" class="pw yellow">BOLSA FARADAY</div>
        <div id="pw-falsificacion" class="pw green">EXTRACCIÓN FÍSICA</div>
      </div>

      <!-- ── SOCIAL PROOFS ── -->
      <div id="sp-container">
        <div id="sp1" class="sp">EL TROYANO ROBÓ CONTRASEÑAS EN SILENCIO</div>
        <div id="sp2" class="sp">AISLAMIENTO INMEDIATO PARA EVITAR BORRADO</div>
        <div id="sp3" class="sp">EXTRACCIÓN FÍSICA DIRECTA DE MEMORIA</div>
      </div>
...
${audioTags}
    ...
    <script>
      ...
      (function () {
        ...
        // Scene 1: TikTok Phishing Link
        function drawTikTokAttack(time, alertColor, cx, cy) {
          ...
          // Draw a mockup smartphone screen outline
          ctx.strokeStyle = "rgba(226, 226, 226, 0.35)";
          ctx.lineWidth = 2;
          ctx.strokeRect(cx - 70, cy - 120, 140, 240);

          // TikTok logo hologram style (overlapping red/cyan notes)
          ctx.font = "bold 64px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(0, 240, 255, 0.85)";
          ctx.fillText("d", cx - 22, cy - 20);
          ctx.fillStyle = "rgba(255, 59, 48, 0.85)";
          ctx.fillText("d", cx - 18, cy - 23);
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("d", cx - 20, cy - 21);

          // Malicious red link hovering
          var linkPulse = 1.0 + 0.05 * Math.sin(time * 6);
          ctx.save();
          ctx.translate(cx, cy + 60);
          ctx.scale(linkPulse, linkPulse);
          ctx.fillStyle = "rgba(255, 59, 48, 0.95)";
          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillText("👉 CLIC AQUÍ 👈", -50, 0);
          ctx.font = "normal 10px 'Share Tech Mono'";
          ctx.fillText("FILTROS_EXCLUSIVOS.APK", -60, 20);
          ctx.restore();

          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(255, 59, 48, 0.9)";
          ctx.fillText("VECTOR: APP PHISHING LINK", px + 35, py + 45);
        }

        // Scene 2: Silent Data Exfiltration
        function drawTrojanDataTheft(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 8;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = alertColor;
          ctx.lineWidth = 4;
          ...
          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(255, 59, 48, 0.9)";
          ctx.fillText("EXFILTRACIÓN SILENCIOSA", px + 35, py + 45);

          // Smartphone and digital bank vault lock
          ctx.strokeStyle = "rgba(255, 59, 48, 0.6)";
          ctx.lineWidth = 2.5;
          ctx.strokeRect(cx - 100, cy - 80, 200, 160);

          // Draw digital bank vault lock
          ctx.beginPath();
          ctx.arc(cx, cy, 40, 0, Math.PI * 2);
          ctx.stroke();

          // Red chains locking bank vaults
          ...
          // Moving red data packet dots representing exfiltration
          var packetY = cy + 40 - ((time * 60) % 100);
          ctx.fillStyle = "#ff3b30";
          ctx.beginPath();
          ctx.arc(cx - 40, packetY, 4, 0, Math.PI * 2);
          ctx.arc(cx + 40, packetY + 20, 4, 0, Math.PI * 2);
          ctx.fill();

          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#ff3b30";
          ctx.fillText("EXTRAYENDO: CONTRASEÑAS BANCARIAS", px + 35, cy + 130);
          ctx.fillText("ALERTA: SIN FIRMA DE SEGURIDAD", px + 35, cy + 155);
        }

        // Scene 3: Faraday Isolation
        function drawFaradayIsolation(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 8;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ctx.strokeStyle = "rgba(254, 207, 6, 0.6)";
          ctx.lineWidth = 4;
          roundRect(ctx, px, py, pw, ph, pr, true, true);

          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(254, 207, 6, 0.9)";
          ctx.fillText("AISLAMIENTO RADIOFRECUENCIA", px + 35, py + 45);

          // Faraday bag shape (trapezoid/pouch)
          ctx.strokeStyle = "rgba(254, 207, 6, 0.8)";
          ctx.fillStyle = "rgba(254, 207, 6, 0.1)";
          ctx.lineWidth = 3;
          ctx.beginPath();
          ...
          // Smartphone inside bag
          ctx.fillStyle = "rgba(12, 15, 15, 0.85)";
          ctx.strokeStyle = "rgba(255, 255, 255, 0.2)";
          ctx.lineWidth = 2;
          roundRect(ctx, cx - 45, cy - 60, 90, 140, 5, true, true);

          // Signal waves decaying as they approach the bag boundary
          ctx.strokeStyle = "rgba(254, 207, 6, 0.45)";
          ctx.lineWidth = 2.5;
          var waveOffset = (time * 25) % 50;
          ctx.beginPath();
          ctx.arc(cx, cy - 10, 110 + waveOffset, 0, Math.PI * 2);
          ctx.stroke();

          // Red "SIGNAL: BLOCKED" flashing
          var flash = Math.floor(time * 3.5) % 2 === 0;
          ctx.font = "bold 13px 'Share Tech Mono'";
          ctx.fillStyle = flash ? "#ff3b30" : "rgba(255, 59, 48, 0.25)";
          ctx.fillText("SEÑAL: 0% RF (BLOQUEADO)", cx - 80, cy + 140);
        }

        // Scene 4: XRY Mobile Extraction
        function drawXryExtraction(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 8;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ...
          ctx.fillText("EXTRACCIÓN FISICA MSAB XRY", px + 30, py + 45);

          // Forensic Workstation and Phone representation
          ctx.strokeStyle = "rgba(0, 240, 255, 0.7)";
          ctx.lineWidth = 2;
          
          // Workstation terminal left
          ctx.strokeRect(cx - 120, cy - 60, 90, 80);
          // Phone right
          roundRect(ctx, cx + 45, cy - 60, 65, 110, 5, false, true);

          // Glowing connecting fiber cables
          ctx.strokeStyle = "rgba(0, 255, 65, 0.85)";
          ctx.lineWidth = 3.5;
          ctx.beginPath();
          ctx.moveTo(cx - 30, cy - 20);
          ctx.bezierCurveTo(cx - 10, cy - 50, cx + 20, cy + 10, cx + 45, cy - 10);
          ctx.stroke();

          // Pulsing bits along the cable
          var bitPos = (time * 0.3) % 1.0;
          ctx.fillStyle = "rgba(0, 255, 65, 0.95)";
          ctx.beginPath();
          ctx.arc(cx - 30 + bitPos * 75, cy - 20 - bitPos * 10, 5, 0, Math.PI * 2);
          ctx.fill();

          var pct = Math.min(100, Math.floor(((time - 24.0) / 8.0) * 100));
          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("MEMORIA VOLATIL: " + pct + "% DUMPED", px + 30, cy + 90);
          ctx.fillStyle = "rgba(0, 255, 65, 0.9)";
          ctx.fillText("EVIDENCIA ADQUIRIDA BAJO REGISTRO", px + 30, cy + 115);
        }

        // Scene 5: Malware Discovery
        function drawMalwareDiscovery(time, alertColor, cx, cy) {
          var px = cx - 180, py = cy - 200, pw = 360, ph = 400, pr = 8;
          ctx.fillStyle = "rgba(12, 15, 15, 0.94)";
          ...
          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(255, 59, 48, 0.9)";
          ctx.fillText("DETECCIÓN DE CÓDIGO MALICIOSO", px + 30, py + 45);

          // Draw binary database rows
          ctx.font = "normal 11px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(255, 255, 255, 0.25)";
          for (var i = 0; i < 4; i++) {
            ctx.fillText("0x7FFE00" + i + " : " + (i === 2 ? "MALWARE_DETECTED" : "OK_SYS_RECORD"), px + 30, cy - 60 + i * 20);
          }

          // Red Warning highlight box over the malware row
          ctx.strokeStyle = "rgba(255, 59, 48, 0.8)";
          ctx.lineWidth = 2;
          ctx.strokeRect(px + 25, cy - 26, 310, 24);

          // Magnifying glass scanning
          var scanX = cx + Math.sin(time * 3) * 60;
          ctx.strokeStyle = "rgba(0, 240, 255, 0.85)";
          ctx.lineWidth = 3.5;
          ctx.beginPath();
          ctx.arc(scanX, cy - 15, 30, 0, Math.PI * 2);
          ctx.moveTo(scanX + 21, cy + 6);
          ctx.lineTo(scanX + 40, cy + 25);
          ctx.stroke();

          ctx.font = "bold 12px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(255, 59, 48, 0.95)";
          ctx.fillText("CARGA UTIL: TROYANO.APK DETECTADO", px + 30, cy + 100);
          ctx.fillStyle = "rgba(0, 255, 65, 0.9)";
          ctx.fillText("CONEXION: PERFIL FALSO DE TIKTOK", px + 30, cy + 122);
        }

        // Scene 6: OSINT Tracking
        function drawOsintRastreo(time, alertColor, cx, cy) {
          ...
          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(0, 255, 65, 0.9)";
          ctx.fillText("RASTREO OSINT & ID UNICO", px + 30, py + 45);

          // Social media profile avatar hologram
          ...
          // Hacker mask / digital profile scan lines
          ...
          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("RASTREO COMPLETO REALIZADO", px + 30, cy + 85);
          ctx.fillStyle = "rgba(0, 240, 255, 0.85)";
          ctx.fillText("OBJETIVO: OBTENCION DE IP Y MAC", px + 30, cy + 108);

          var fl = Math.floor(time * 4) % 2 === 0;
          ctx.font = "bold 13px 'Share Tech Mono'";
          ctx.fillStyle = fl ? "rgba(0, 255, 65, 0.9)" : "rgba(0, 255, 65, 0.25)";
          ctx.fillText(">>> ID CIBERCRIMINAL VERIFICADO <<<", px + 30, cy + 140);
        }

        // Scene 7: Justice / Gavel Slam
        function drawGavel(time, alertColor, cx, cy) {
          ...
          ctx.fillText("CONDENA: FRAUDE DE DATOS", px + 35, py + 45);

          // Balance scales of justice tilting with gavel slam
          ctx.strokeStyle = "rgba(0, 255, 65, 0.75)";
          ctx.lineWidth = 3.5;
          
          var sway = Math.sin(time * 3) * 8; // Gavel impact vibration
          ...
          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("CUSTODIA PENAL FEDERAL", px + 25, cy + 90);
          ctx.fillStyle = "rgba(0, 255, 65, 0.9)";
          ctx.fillText("COOPERACIÓN JUDICIAL ACTIVA", px + 25, cy + 115);
          ctx.fillText("DELITO: FRAUDE DE IDENTIDAD", px + 25, cy + 135);
        }

        // Scene 8: Shield Protection
        function drawShield(time, alertColor, cx, cy) {
          ...
          ctx.font = "normal 14px 'Share Tech Mono'";
          ctx.fillStyle = "rgba(0, 255, 65, 0.9)";
          ctx.fillText("PROTEGE TU IDENTIDAD DIGITAL", px + 35, py + 45);
          ...
          // Inside shield, draw a smartphone lock icon
          ...
          // Rotating protective cyber rings around shield
          ...
          ctx.font = "normal 12px 'Share Tech Mono'";
          ctx.fillStyle = "#e2e2e2";
          ctx.fillText("EVITA ENLACES SOSPECHOSOS", px + 35, cy + 138);
          ctx.fillStyle = "rgba(0, 240, 255, 0.85)";
          ctx.fillText("COMPLIANCE: SEGURIDAD DIGITAL", px + 35, cy + 160);
        }
        ...
        function drawForensicSimulation(time) {
          ...
          if (time >= 0.0 && time < 16.0) {
            alertColor = "rgba(255, 59, 48, 0.5)"; // Alert red
          ...
          if (time < 8.0) {
            drawTikTokAttack(time, alertColor, cx, cy);
          } else if (time >= 8.0 && time < 16.0) {
            drawTrojanDataTheft(time, alertColor, cx, cy);
          } else if (time >= 16.0 && time < 24.0) {
            drawFaradayIsolation(time, alertColor, cx, cy);
          } else if (time >= 24.0 && time < 32.0) {
            drawXryExtraction(time, alertColor, cx, cy);
          } else if (time >= 32.0 && time < 40.0) {
            drawMalwareDiscovery(time, alertColor, cx, cy);
          } else if (time >= 40.0 && time < 48.0) {
            drawOsintRastreo(time, alertColor, cx, cy);
          } else if (time >= 48.0 && time < 56.0) {
      ...
      tl.to("#sha256-v11", { x: 20, y: -20, duration: 0.04, ease: "none", repeat: 4, yoyo: true }, 39.85);
      tl.to("#sha256-v11", { x: 0, y: 0, duration: 0.05, ease: "none" }, 40.06);
      tl.to("#sha256-v11", { filter: "invert(0.9) sepia(1) saturate(3) hue-rotate(320deg)", duration: 0.08, ease: "none" }, 39.85);
      tl.to("#sha256-v11", { filter: "none", duration: 0.15, ease: "power2.out" }, 39.93);
      ...
      tl.to("#sha256-v11", { filter: "blur(20px) contrast(1.4)", scale: 1.12, duration: 0.16, ease: "power2.in" }, 55.84);
      tl.to("#sha256-v11", { filter: "none", scale: 1.0, duration: 0.25, ease: "power3.out" }, 56.0);
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 3 — Aislamiento (t = 16.0–24.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c3-bg",
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 4 — Extracción (t = 24.0–32.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c4-bg",
        { scale: 1.2, x: -25, y: 20 },
      ...
      /* ─────────────────────────────────────────────────────
         CLIP 6 — Rastreo OSINT (t = 40.0–48.0s)
         ───────────────────────────────────────────────────── */
      tl.fromTo(
        "#c6-bg",
        { scale: 1.2, x: 15, y: -25 },
      ...
      tl.to("#sha256-v11", { opacity: 0, duration: 0.6, ease: "power2.in" }, 63.4);

      /* ─────────────────────────────────────────────────────
         POWER WORDS TIMING
         ───────────────────────────────────────────────────── */
      // PW1: "TROYANO BANCARIO" (t = 6.2s to 7.8s)
      ...
      // PW2: "BOLSA FARADAY" (t = 21.0s to 23.0s)
      ...
      // PW3: "EXTRACCIÓN FÍSICA" (t = 44.5s to 46.8s)
      ...
      /* ─────────────────────────────────────────────────────
         ...
         ───────────────────────────────────────────────────── */
      window.__timelines["sha256-v11"] = tl;
    </script>
  </body>
</html>
`;
...
const destDir = path.join(ROOT_DIR, "videos", "sha256-v11");
...
console.log("videos/sha256-v11/index.html generado exitosamente!");
